...
export async function doDownload(method: string, url: string, data?: any, headers?: any) {
    let promise = new Promise((resolve, reject) => {
        let config: any = {
            method: method,
            url: url,
...
export async function doPost(context: any, url: string, data?: any, headers?: any) {
    let result = await axiosAction(context, 'POST', url, data, headers);
    return result;
}

export async function doGet(context: any, url: string, data?: any, headers?: any) {
    let result = await axiosAction(context, 'GET', url, data, headers);
    return result;
}

export async function doDelete(context: any, url: string, data?: any, headers?: any) {
    let result = await axiosAction(context, 'DELETE', url, data, headers);
    return result;
}

export async function doPut(context: any, url: string, data?: any, headers?: any) {
    let result = await axiosAction(context, 'PUT', url, data, headers);
    return result;
}
